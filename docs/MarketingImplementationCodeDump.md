...
export const metadata: Metadata = marketingMetadata({
  ...
  description:
    'Switch from Sortly to Pickle for trust-first pricing, offline-first barcode scanning, and real check-in/check-out workflows built for small teams.',
...
const SORTLY_FAQS: FaqItem[] = [
  {
    ...
    answer:
      'No. Pickle is designed to scale predictably so you aren’t forced into a huge tier jump just because your catalog grows.',
  },
  {
    question: 'Can my team scan and update inventory offline?',
    answer:
      'Yes. Pickle is built for offline-first mobile workflows so scanning and updates keep working when Wi‑Fi is unreliable.',
  },
  {
    question: 'Can I track tools and assets checked out to employees?',
    answer:
      'Yes. Pickle supports a real check-in/check-out workflow so you can assign items, set due dates, and stay accountable.',
  },
  {
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="text-base-content/80 mt-3 max-w-3xl text-lg">
              Pickle is built for barcode scanning, offline reliability, and accountability workflows (check-in/check-out)
        ...
        <div className="mt-10 rounded-box bg-base-200 p-6 sm:p-8">
          ...
          <p className="text-base-content/80 mt-2 max-w-3xl">
            If you&apos;re feeling price shock, need offline scanning, or you track tools/assets checked out to staff, Pickle
          ...
          <p className="text-base-content/60 mt-4 text-sm">
            Pickle and Sortly are trademarks of their respective owners. This page is based on publicly available
...
export const metadata: Metadata = marketingMetadata({
  ...
  description:
    'Privacy policy for Pickle Inventory. Learn what data we collect, how we use it, and your choices as a customer.',
  pathname: '/privacy',
})
  ...
  return (
    <div className="bg-base-100 pt-28 md:pt-32">
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
        ...
        <p className="text-base-content/80 mt-3">
          This is a plain-language privacy policy for Pickle. Replace this with your final legal copy before launch.
        </p>
        ...
        <div className="mt-10 space-y-10">
          <section>
            ...
            <ul className="text-base-content/80 mt-4 list-disc space-y-2 pl-6">
              ...
              <li>Workspace data you store in Pickle (inventory items, locations, activity logs).</li>
