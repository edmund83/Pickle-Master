...
| Plan | Price (USD/mo) | Items (SKUs) | Users | Locations | AskZoe AI Questions / Month |
|---|---:|---:|---:|---:|---:|
...
| **Locations — Multi-location inventory** | ❌ *(single location only)* | ✅ | ✅ |
...
| **AskZoe AI — Included monthly quota** | ❌ | ✅ (100/mo) | ✅ (500/mo) |
