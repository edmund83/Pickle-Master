-- ============================================
-- Migration: 00053_pick_list_locations.sql
-- Purpose: Add location data to pick list items for location-aware picking
-- ============================================

-- ===================
-- UPDATE get_pick_list_with_items RPC
-- Now includes location data for each item so pickers know WHERE to find items
-- ===================
        ...
        SELECT json_build_object(
            ...
            'items', (
                SELECT COALESCE(json_agg(json_build_object(
                    ...
                    'notes', pli.notes,
                    -- NEW: Include location data for each item
                    'locations', (
                        SELECT COALESCE(json_agg(json_build_object(
...
'Returns pick list with items including location data for each item.
